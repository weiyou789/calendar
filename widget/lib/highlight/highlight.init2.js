...
function textAreaToHTML(){
	var textarea = $("script[type='text\/html']");
	...
	$(".clipBtn").each(function(){
		...
		var btnID = this.id;
		var text = $(this).parent().siblings("script").html();
...
$(function(){
	...
	textAreaToHTML();
	hljs.tabReplace = '<span style="display:inline-block;width:2em;" class="indent"></span>';
